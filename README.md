...
当前版本：**0.2.5-ui**。已实现 1024 × 600 Qt Widgets 页面与交互，可编译运行。
...
- **倒车影像**：进入页面时自动打开 Linux `/dev/video9`，优先请求 1280 × 720 / 30 FPS；画面水平镜像，以 Qt 平滑算法按比例显示并叠加三段辅助线，返回或按 Esc 自动停止并释放设备。
